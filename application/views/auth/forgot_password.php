...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/png" sizes="192x192" href="a<?php echo base_url(); ?>assets/src/ssets/media/favicons/favicon-192x192.png">
    ...
    <body>
                            ...
                            <div class="content content-full">
                                <div class="row justify-content-center">
                                    <div class="col-md-8 col-lg-6 col-xl-4 py-4">
                                        ...
                                        <div class="text-center">
                                            <a class="font-size-sm font-w500" href="op_auth_signin2.html">Login?</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <!-- Page JS Plugins -->
        <script src="<?php echo base_url(); ?>assets/src/assets/js/plugins/jquery-validation/jquery.validate.min.js"></script>

        <!-- Page JS Code -->
        <script src="<?php echo base_url(); ?>assets/src/assets/js/pages/op_auth_reminder.min.js"></script>
    </body>
</html>
