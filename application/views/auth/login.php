...
<html lang="en">
    ...
    <body>
            ...
            <main id="main-container">
                ...
                <div class="hero-static">
                                ...
                                <div class="block block-rounded block-themed mb-0">
                                    <div class="block-header bg-primary-dark">
                                        ...
                                        <div class="block-options">
                                            <a class="btn-block-option font-size-sm" href="<?php echo base_url(); ?>forgot">Forgot Password?</a>
                    ...
                    <div class="content content-full font-size-sm text-muted text-center">
                        <strong>Maktepung</strong> &copy; <span data-toggle="year-copy"></span>
                    </div>
                </div>
                <!-- END Page Content -->
            </main>
        ...
        <!-- Page JS Code -->
        <script src="<?php echo base_url(); ?>assets/src/assets/js/pages/op_auth_signin.min.js"></script>
    </body>
</html>
